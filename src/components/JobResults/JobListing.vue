    ...
    >
      <div class="pt-5 pb-2 mx-8 border-b border-solid border-brand-gray-2">
        ...
        <div class="flex flex-row align-middle">
          <div class="mr-5">
            <span>Ship Happens</span>
          </div>
          <div>
            <span> Bovallstrandsgatan, Goteborg</span>
          </div>
        </div>
      </div>
      <div class="px-8 py-4">
        <div>
          ...
          <div>
            <ul class="pl-8 list-disc">
              <li>Bachelors degree or equivalent practive experience</li>
              <li>No experience in program management</li>
              <li>
